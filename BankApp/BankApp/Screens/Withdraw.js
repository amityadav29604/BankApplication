...
const Withdraw = ({navigation,route}) => {
    ...
    const withdraw = (accNo) => {
        axios({
            method: 'POST',
            url: 'http://192.168.0.102:8087/IDFC/Customer/withdraw/' + accNo +"/"+ amount, 
  ...
  return (
    <View style={[styles.container,{alignItems:'center'}]}>
            <View style={styles.headview}>
                ...
                <Text style={[styles.userDetails,{fontSize:25}]}>Withdraw Here {uName} !</Text>
            </View>
            <View style={{marginTop:30, marginBottom:40}}>
                <Text style={styles.text}>Enter Withdrawl Amount:</Text>
